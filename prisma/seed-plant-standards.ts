...
const presses: PressData[] = [
  ...
  // ── Carrier / phantom presses (added 8/18 from Mary's 36-quote batch) ──
  // Mary runs DIGITAL and CONVERTING-ONLY work through a placeholder press at
  // ~0 hours; the real production is bought as an outside purchase. These two
  // appear on 15 of her 36 quotes and had no home in Godzilla at all, so those
  // jobs were unquotable.
  {
    pressNumber: 40,
    name: "MILLE",
    costPerHour: 0,
    ...
    configs: [
      {
        ...
        maxImpressions: 0,
        plateCost: 0,
        plateDevelopMinutes: 0,
        strippingMaterialCost: 0,
        setupWasteUncoated: 0,
        setupWasteCoated: 0,
        plateChangeWasteUncoated: 0,
        plateChangeWasteCoated: 0,
        wasteCurveUncoated: flatWasteCurve,
        wasteCurveCoated: flatWasteCurve,
      },
    ],
