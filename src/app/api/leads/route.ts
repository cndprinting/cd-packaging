...
export async function PUT(request: NextRequest) {
  ...
  const data: any = {};
  for (const k of ["companyName", "endMarket", "productCategory", "website", "contactName", "contactTitle", "contactEmail", "contactPhone", "stage", "pipelineStage", "ownerName", "volume", "commentary"]) {
