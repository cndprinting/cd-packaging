...
export async function GET(request: NextRequest) {
  ...
  const rows = await prisma.lead.findMany({
    ...
    select: {
      ...
      summary: true, summaryAt: true, summaryNotes: true,
      ...
      contacts: { orderBy: { sort: "asc" as const }, select: { id: true, name: true, title: true, email: true, phone: true, emailCandidates: true, phoneCandidates: true, phoneConfirmedAt: true, phoneConfirmedBy: true, sort: true } },
    },
  });
