...
import { TrendingUp, Lock, Loader2, Plus, X, AlertTriangle, ArrowRight, Link2 } from "lucide-react";
...
type Lead = {
  ...
  ownerName: string | null; volume: string | null; commentary: string | null; companyId: string | null;
};
              ...
              {visible.map((l) => (
                <tr key={l.id} className="border-t border-gray-100 align-middle">
                  <td className="px-3 py-2">
                    ...
                    {l.endMarket && <div className="text-xs text-gray-400">{l.endMarket}</div>}
                  </td>
