...
import { AGENT_NAME } from "@/lib/agent/identity";
...
- Sign off with just the name "${AGENT_NAME}" (a company signature block is appended automatically).
